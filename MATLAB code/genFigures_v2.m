...
plot(SNRdB_list([1:5, 8, 10]), yNoJam_SINR_p05([1:5, 8, 10]), '-' );
hold on
plot(SNRdB_list([1:5, 8, 10]), yDet_noncausal_SINR_p05([1:5, 8, 10]), 'o' );
plot(SNRdB_list([1:5, 8, 10]), yStat_m2_SINR_p05([1:5, 8, 10]), '-s' );
plot(SNRdB_list([1:5, 8, 10]), yStat_SINR_p05([1:5, 8, 10]), '^' );
plot(SNRdB_list([1:5, 8, 10]), yDet_causal_SINR_p05([1:5, 8, 10]), '--*' );
plot(SNRdB_list([1:5, 8, 10]), yUniform_SINR_p05([1:5, 8, 10]), '--' );
plot(SNRdB_list([1:5, 8, 10]), yNoFH_SINR_p05([1:5, 8, 10]), 'k--' );
...
fig_filename = sprintf("FH_SINR_Ns%d_Nu%d_4.png", Ns, Nu);
...
% semilogy(SNRdB_list([1:5, 8, 10]), yNoFH_BER_p40([1:5, 8, 10]), '-'); 
...
grid on
fig_filename = sprintf("FH_BER_Ns%d_Nu%d_3.png", Ns, Nu);
saveas(gcf, fig_filename);
fig_filename = sprintf("FH_BER_Ns%d_Nu%d_3.fig", Ns, Nu);
saveas(gcf, fig_filename);
...
%     title(sprintf('SNR: %d dB', SNRdB_list(ii)))
    ...
    grid on
    xlim([1e-5,1])
    fig_filename = sprintf("FH_BER_percentiel_SNR%d_3.png", SNRdB_list(ii));
    saveas(gcf, fig_filename);
    fig_filename = sprintf("FH_BER_percentiel_SNR%d_3.fig", SNRdB_list(ii));
    saveas(gcf, fig_filename);
end
